                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="number" placeholder="Text" class="form-control" value="<?php echo $gAchi[0]['number'] ?>" maxlength="11" required>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="body" placeholder="Text" class="form-control" value="<?php echo $gAchi[0]['body'] ?>" maxlength="100" required>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="altImg" placeholder="Text" class="form-control" value="<?php echo $gAchi[0]['alt_image'] ?>" maxlength="100" required>
                                                    <small class="help-block form-text">Max Character 100</small>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="title" placeholder="Text" class="form-control" value="<?php echo $gAchi[0]['title'] ?>" maxlength="100" required>
                                                    <small class="help-block form-text">Max Character 100</small>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                        ...
                                        if(isset($_POST['submit'])) {
                                            if($_FILES['file']['size'] != 0 && $_FILES['file']['error'] == 0){
                                                ...
                                                $achi->updateAchi($id,$admin_id,$number,$body);
                                            } else {
                                                $id                 = $_GET['id'];
                                                $media_id           = $gAchi[0]['media_id'];
                                                $number             = $_POST['number'];
                                                $body               = $_POST['body'];
                                                $alt                = $_POST['altImg'];
                                                $titleImg           = $_POST['title'];
                                                ...
                                                $achi->updateAchiWithOutImage($id,$admin_id,$number,$body);
                                            }
                                        }
                                        ?>
                                    </div>
